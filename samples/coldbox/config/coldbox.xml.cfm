...
<Config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
	...
	<Settings>
		...
		<Setting name="AppName"						value="ofc-cfc"/>
		...
		<Setting name="DefaultEvent" 				value="ehChart.index"/>
	...
	<Interceptors>
		...
		<Interceptor class="coldbox.system.interceptors.coldboxSideBar">
			...
			e.g. 
 			...
 			<Property name="links">
					[
					{"desc":"OFC-Coldfusion API","href":"\/\/ofc-cfc.googlecode.com\/svn\/docs\/api\/index.html"}
					,{"desc":"Generate OFC-CF API Docs","href":"?event=ehDeveloper.doGenerateDocs"}
					]
			</Property>
